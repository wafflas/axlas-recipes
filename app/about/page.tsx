...
export const metadata: Metadata = {
  title: "About | AXLAS COOKS",
  description: "About Axlas Cooks.",
};

export default function AboutPage() {
  return (
    <main className="w-full min-h-screen bg-[var(--color-primary)]">
      <HeroTitle title="ABOUT" subtitle="THE STORY BEHIND THE PAGE" />
        ...
        <div className="space-y-8">
          <div className="space-y-6">
            ...
            <p className="text-lg text-black/70 font-inter leading-relaxed">
              Axlas Cooks is a small editorial archive of the dishes I cook,
